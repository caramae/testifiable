...
class DatapointsControllerTest < ActionController::TestCase
  ...
  test "should create datapoint" do
    assert_difference('Datapoint.count') do
      post :create, datapoint: { experiment_id: @datapoint.experiment_id, user_id: @datapoint.user_id, value: @datapoint.value }
    end
  ...
  test "should update datapoint" do
    patch :update, id: @datapoint, datapoint: { experiment_id: @datapoint.experiment_id, user_id: @datapoint.user_id, value: @datapoint.value }
    assert_redirected_to datapoint_path(assigns(:datapoint))
  end
