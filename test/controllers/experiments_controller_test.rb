...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { action: @experiment.action, control: @experiment.control, outcome: @experiment.outcome, unit: @experiment.unit }
    end
  ...
  test "should update experiment" do
    patch :update, id: @experiment, experiment: { action: @experiment.action, control: @experiment.control, outcome: @experiment.outcome, unit: @experiment.unit }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
